...
<body class="gray-bg" ng-app="Thesis">
				...
				<div class="form-group">
					<div class="input-group m-b">
						<span class="input-group-addon">验证码：</span> <input type="text"
							...
							<span style="padding:1px;width:100px;" class="input-group-addon">
								<img ng-src="{{captchaurl}}" id="kaptchaImage" style="height:30px;vertical-align:middle;" ng-click="changeCaptcha()" title="点击刷新"  alt="点击刷新" >
							</span>
					</div>
				</div>
				<div class="form-group">
					...
					<div id="layout" class="loadinglayout">
						<img src="images/shishiloading.gif" />
					</div>
				</div>
	...
	<#include "/incjs.ftl" >
	<!-- Angularjs Custom -->
     <script src="jslib/app/controller/loginController.js"></script>
<%--	<script src="<%=contextPath%>/jslib/app/service/loginService.js"></script>
	<script src="jslib/app/service/departmentworkflowService.js"></script> --%>
</body>
</html>
